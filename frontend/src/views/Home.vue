      ...
      >
        ...
        <a-form-item>
          ...
          <div style="text-align: center; margin-top: 24px;">
            <a-button type="link" @click="handleViewTrace" style="color: #667eea; font-weight: 500; font-size: 16px;">
              🔍 查看系统运行轨迹
            </a-button>
          </div>
        </a-form-item>
...
import { generateTripPlan, getLatestTrace } from '@/services/api'
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (response.success && response.data) {
      tripPlanStore.setTripPlan(response.plan_id ?? null, response.data)
      ...
      setTimeout(() => {
        router.push({
          name: 'Result',
          params: response.plan_id ? { planId: response.plan_id } : {}
        })
      }, 500)
    } else {
